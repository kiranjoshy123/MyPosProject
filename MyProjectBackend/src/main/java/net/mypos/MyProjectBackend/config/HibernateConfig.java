package net.mypos.MyProjectBackend.config;
...
@Configuration
@ComponentScan(basePackages= {"net.mypos.MyProjectBackend.dto"})
...
public class HibernateConfig {
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("net.mypos.MyProjectBackend.dto");
	...
	public HibernateTransactionManager getTranscationManager(SessionFactory sessionFactory) {
		HibernateTransactionManager transcationManger = new HibernateTransactionManager(sessionFactory);
		return transcationManger;
	}
